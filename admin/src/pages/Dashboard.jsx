...
const AdminDashboard = () => {
  ...
  const recentAlerts = [
    { id: 1, type: "emergency", message: "Tourist entered restricted zone - Kaziranga Core Area", time: "2 min ago", status: "active" },
    { id: 2, type: "missing", message: "No activity detected for 3 hours - Tourist ID: TID2847", time: "15 min ago", status: "investigating" },
    { id: 3, type: "panic", message: "Panic button pressed - Cherrapunji Trek Route", time: "1 hour ago", status: "resolved" },
    { id: 4, type: "geofence", message: "Multiple tourists near border zone - Dawki Bridge", time: "2 hours ago", status: "monitoring" },
    { id: 5, type: "health", message: "IoT device shows irregular heartbeat - Device ID: IOT156", time: "3 hours ago", status: "resolved" },
  ];
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-600">{dashboardStats.activeTourists.toLocaleString()}</p>
                </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-red-600">{dashboardStats.emergencyAlerts}</p>
                </div>
              ...
              <div className="mt-4 flex items-center">
                ...
                <span className="text-sm text-red-600">2 require immediate action</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-purple-600">{dashboardStats.iotDevices}</p>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200">
              <div className="p-6 border-b border-gray-200">
                <h3 className="text-lg font-semibold text-gray-900">Recent Alerts & Incidents</h3>
              </div>
              <div className="p-6">
                    ...
                    <div key={alert.id} className="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg">
                      <div
                        className={`w-2 h-2 rounded-full mt-2 ${
                          ...
                          alert.type === "panic" ? "bg-orange-500" :
                          alert.type === "missing" ? "bg-yellow-500" : "bg-blue-500"
                        }`}
                      />
            ...
            <div className="bg-white rounded-xl border border-gray-200">
              <div className="p-6 border-b border-gray-200">
                <h3 className="text-lg font-semibold text-gray-900">Tourist Heat Map</h3>
              </div>
                  ...
                  <div key={index} className="flex items-center justify-between">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${
                        ...
                        zone.risk === "medium" ? "bg-yellow-100 text-yellow-700" : "bg-green-100 text-green-700"
                      }`}
                    >
                      {zone.risk} risk
                    </span>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <button className="p-4 bg-green-50 rounded-lg text-center hover:bg-green-100 transition-colors">
                ...
                <p className="text-sm font-medium text-green-900">Track Tourist</p>
              </button>

              <button className="p-4 bg-purple-50 rounded-lg text-center hover:bg-purple-100 transition-colors">
                <FileText className="w-6 h-6 text-purple-600 mx-auto mb-2" />
                <p className="text-sm font-medium text-purple-900">Create E-FIR</p>
              </button>
            </div>
          </div>
        </main>
